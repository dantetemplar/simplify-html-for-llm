# https://github.com/shashstormer/pytailwindcss
...
class Tailwind:
    def __init__(self):
        ...
        self.classes = {
            ...
            "animationFillMode": {"none": "none", "forwards": "forwards", "backwards": "backwards", "both": "both"},
            "animationPlayState": {"running": "running", "paused": "paused"},
            "aria": {
                "busy": 'busy="true"',
            ...
            "backdrop-filter": {
                ...
                "grayscale": {"0": "grayscale(0)", "DEFAULT": "grayscale(1)"},
                "hue-rotate": {
                    "0": "hue-rotate(0deg)",
                    "15": "hue-rotate(15deg)",
                    "30": "hue-rotate(30deg)",
                ...
                "invert": {"0": "invert(0)", "DEFAULT": "invert(1)"},
                "opacity": {
                    "0": "opacity(0)",
                    "5": "opacity(.05)",
                    "10": "opacity(.1)",
                ...
                "sepia": {"0": "sepia(0)", "DEFAULT": "sepia(1)"},
            },
            "backgroundImage": {
                "none": "none",
                "gradient": {
            ...
            "fontStyle": {"italic": "italic", "oblique": "oblique", "not-italic": "normal"},
            "fontWeight": {
                "thin": "100",
                "extralight": "200",
                "light": "300",
            ...
            "overflow": {
                ...
                "visible": "visible",
                "scroll": "scroll",
                "x": {"auto": "auto", "hidden": "hidden", "clip": "clip", "visible": "visible", "scroll": "scroll"},
                "y": {"auto": "auto", "hidden": "hidden", "clip": "clip", "visible": "visible", "scroll": "scroll"},
            },
            "outlineOffset": {
                "0": "0px",
                "1": "1px",
            ...
            "textWrap": {"wrap": "wrap", "nowrap": "nowrap", "balance": "balance", "pretty": "pretty"},
            "textUnderlineOffset": {
                "auto": "auto",
                "0": "0px",
                "1": "1px",
        ...
        for color in self.colors:
            ...
            if isinstance(val, str):
                self.classes["from"][color] = (
                    f"""--tw-gradient-from: {val} var(--tw-gradient-from-position);--tw-gradient-to: {val + "00" if val.startswith("#") else val} var(--tw-gradient-to-position);--tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);"""
                )
                self.classes["via"][color] = (
                    f"""--tw-gradient-to: {val + "00" if val.startswith("#") else val}  var(--tw-gradient-to-position);--tw-gradient-stops: var(--tw-gradient-from), {val} var(--tw-gradient-via-position), var(--tw-gradient-to);"""
                )
            ...
            for clr_no in clr_nos:
                ...
                if color not in self.classes["from"]:
                    ...
                    self.classes["via"][color] = {}
                self.classes["from"][color][clr_no] = (
                    f"""--tw-gradient-from: {val} var(--tw-gradient-from-position);--tw-gradient-to: {val + "00" if val.startswith("#") else val} var(--tw-gradient-to-position);--tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);"""
                )
                self.classes["via"][color][clr_no] = (
                    f"""--tw-gradient-to: {val + "00" if val.startswith("#") else val}  var(--tw-gradient-to-position);--tw-gradient-stops: var(--tw-gradient-from), {val} var(--tw-gradient-via-position), var(--tw-gradient-to);"""
                )
